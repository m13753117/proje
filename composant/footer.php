<div class="foo">
    ...
    <div class="col-lg-4">
      <div class="propos">
        <h2 class="foo-headline">A propos & Administration des Emprunts</h2>
        <p>Ce site a ete concu dans le cadre des mini projects asigner aux etudiant.<br><a href="admin/index.php">Administration</a>
      </p>
    ...
    <div class="col-lg-4">
      ...
      <div class="team">        
        <ul>
          ...
          <li><a herf="#">Altine Sanda Ismael</a></li>
...
<div class="rights" >
  © 2025 copyrights to <span class="italic">NGR</span>
</div>
